...
static const char *const kWelcomeTextURL = "../assn-4-rss-news-search-data/welcome.txt";
static const char *const kDefaultStopWordsURL = "../assn-4-rss-news-search-data/stop-words.txt";
static const char *const kDefaultFeedsFileURL = "../assn-4-rss-news-search-data/rss-feeds.txt";
